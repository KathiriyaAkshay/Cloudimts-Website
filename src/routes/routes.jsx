...
const InstitutionLogs = React.lazy(() => import("../pages/Institution/InstitutionLogs"));
...
export const routes = [
  ...
  { path: "/institutions-logs", component: <Loader component={InstitutionLogs} /> },
  {
  ...
  { path: "/upload-images", component: <Loader component={Dicom} /> },
