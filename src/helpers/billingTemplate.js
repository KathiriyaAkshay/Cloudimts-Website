                      ...
                      <div class="border-top border-gray-200 pt-4 mt-4">
                                ...
                                <table class="table border-bottom border-gray-200 mt-3">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" class="fs-sm text-dark text-uppercase-bold-sm px-0">Number Of Cases</th>
                            ...
                            <a href="#!" class="btn btn-dark btn-lg card-footer-btn justify-content-center text-uppercase-bold-sm hover-lift-light">
                                <span class="svg-icon text-white me-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="512" height="512" viewBox="0 0 512 512"><title>ionicons-v5-g</title><path d="M336,208V113a80,80,0,0,0-160,0v95" style={{
                                        fill: 'none',
                                        stroke: '#000',
                                        strokeLinecap: 'round',
                                        strokeLinejoin: 'round',
                                        strokeWidth: '32px',
                                    }}></path><rect x="96" y="208" width="320" height="272" rx="48" ry="48" style={{
                                        fill: 'none',
                                        stroke: '#000',
                                        strokeLinecap: 'round',
                                        strokeLinejoin: 'round',
